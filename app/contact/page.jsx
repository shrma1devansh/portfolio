...
const info = [
  {
    icon: <FaPhoneAlt />,
    title: "Phone",
    description: "(+91) 6264286662",
  },
  {
    icon: <FaEnvelope />,
    title: "E-mail",
    description: "devansh7645@gmail.com",
  },
  {
    icon: <FaMapMarkerAlt />,
    title: "Address",
    description: "volantis",
  },
];
          ...
          <div className="xl:w-[54%] order-2 xl:order-none">
            <form className="flex flex-col gap-6 p-10 bg-[#27272c] rounded-xl">
              ...
              <p className="text-white/60">
                Passionate software developer dedicated to crafting innovative,
              ...
              <Select>
                ...
                <SelectContent>
                  <SelectGroup>
                    ...
                    <SelectItem value="mst">Blockchain Developer</SelectItem>
                  </SelectGroup>
                </SelectContent>
              </Select>
              {/* text area */}
